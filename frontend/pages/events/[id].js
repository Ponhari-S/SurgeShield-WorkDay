      ...
      <div className="card" style={{ marginBottom: 32, padding: 32 }}>
        ...
        >
          ...
          <div className="meta-row">
            ...
            <span>
              <strong style={{ color: '#3b82f6' }}>{availableSeatsCount}</strong> of {totalSeats} seats open
            </span>
          </div>
        </div>
      </div>
      ...
      {!user ? (
        <div className="form-card" style={{ textAlign: 'center', padding: '40px 24px' }}>
          <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'center' }}>
            <div style={{ width: 44, height: 44, borderRadius: 10, background: 'var(--primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff' }}>
